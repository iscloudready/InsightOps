...
function Start-TempoTestSequence {
    ...
    try {
        ...
        # Validate configuration if SkipValidation is not set
...
# Execute the test sequence with parameters from config.json
Start-TempoTestSequence @PSBoundParameters